...
class TestDatabase(unittest.TestCase):
    def test_build_mongo_uri_direct(self):
        ...
        self.assertEqual(ConnectionService.build_mongo_uri(req), "mongodb://localhost:27017/")
    ...
    def test_build_mongo_uri_atlas_no_dot(self):
        ...
        self.assertEqual(ConnectionService.build_mongo_uri(req), "mongodb+srv://user:pass@cluster0.mongodb.net/")
    ...
    def test_build_mongo_uri_atlas_with_one_dot(self):
        ...
        self.assertEqual(ConnectionService.build_mongo_uri(req), "mongodb+srv://user:pass@cluster0.vvtqpfm.mongodb.net/")
    ...
    def test_build_mongo_uri_custom_domain(self):
        ...
        self.assertEqual(ConnectionService.build_mongo_uri(req), "mongodb+srv://user:pass@mongo.mycompany.com/")
    ...
    def test_build_mongo_uri_url_encoding(self):
        ...
        self.assertEqual(ConnectionService.build_mongo_uri(req), expected)
